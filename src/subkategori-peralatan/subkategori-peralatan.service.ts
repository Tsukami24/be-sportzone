...
export class SubkategoriPeralatanService {
  ...
  async create(
    createSubkategoriPeralatanDto: CreateSubkategoriPeralatanDto,
  ): Promise<SubkategoriPeralatan> {
    ...
    const subkategoriPeralatan = this.subkategoriPeralatanRepository.create(
      createSubkategoriPeralatanDto,
    );
  ...
  async findOne(id: string): Promise<SubkategoriPeralatan> {
    const subkategoriPeralatan =
      await this.subkategoriPeralatanRepository.findOne({
        where: { id },
        relations: ['kategoriOlahraga'],
      });
  ...
  async findByKategoriOlahraga(
    kategoriOlahragaId: string,
  ): Promise<SubkategoriPeralatan[]> {
    return await this.subkategoriPeralatanRepository.find({
  ...
  async update(
    id: string,
    updateSubkategoriPeralatanDto: UpdateSubkategoriPeralatanDto,
  ): Promise<SubkategoriPeralatan> {
