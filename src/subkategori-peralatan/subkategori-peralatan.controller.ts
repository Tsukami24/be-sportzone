...
export class SubkategoriPeralatanController {
  constructor(
    private readonly subkategoriPeralatanService: SubkategoriPeralatanService,
  ) {}
  ...
  create(@Body() createSubkategoriPeralatanDto: CreateSubkategoriPeralatanDto) {
    return this.subkategoriPeralatanService.create(
  ...
  update(
    @Param('id') id: string,
    @Body() updateSubkategoriPeralatanDto: UpdateSubkategoriPeralatanDto,
  ) {
    return this.subkategoriPeralatanService.update(
      id,
      updateSubkategoriPeralatanDto,
    );
  }
